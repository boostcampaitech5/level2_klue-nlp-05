...
def train():
  ...
  if CFG['MODEL_TYPE'] == 'base':
    ...
    tokenized_train, restrict_num_train = punct_tokenized_dataset(train_dataset, tokenizer)
    tokenized_dev, restrict_num_dev = punct_tokenized_dataset(dev_dataset, tokenizer)
